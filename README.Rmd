...
# LCARS-C <img src="man/figures/logo.png" align="right" width=160 height=160 alt="" />
  ...
  <!-- badges: start -->
  [![Codecov test coverage](https://codecov.io/gh/hcstubbe/lcarsc/branch/master/graph/badge.svg)](https://app.codecov.io/gh/hcstubbe/lcarsc?branch=master)
  <!-- badges: end -->
...
Using LCARS-C locally: In this example, the database is saved in the working directory as 'db_test_data.sqlite3.sqlite3' and 'db_test_cfg.sqlite3.sqlite3'. The preview data is saved as 'db_preview.sqlite3'. 'db_preview.sqlite3' is overwritten each time the software reboots or the page reloads.
